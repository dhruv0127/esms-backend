...
const setup = async (req, res) => {
  ...
  for (const filePath of settingsFiles) {
    ...
    const settingsToUpdate = {
      kreddo_app_email: email,
      kreddo_app_company_email: email,
      kreddo_app_timezone: timezone,
      kreddo_app_country: country,
      kreddo_app_language: language || 'en_us',
    };
  ...
  return res.status(200).json({
    success: true,
    result: {},
    message: 'Successfully Kreddo App Setup',
  });
};
